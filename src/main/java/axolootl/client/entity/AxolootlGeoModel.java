...
public class AxolootlGeoModel<T extends LivingEntity & LerpingModel & IAxolootl & IAnimatable> extends AnimatedGeoModel<T> {
    ...
    public ResourceLocation getAnimationResource(T entity) {
        return entity.getAxolootlVariant(entity.level.registryAccess()).orElse(AxolootlVariant.EMPTY).getModelSettings().getOptionalEntityGeoAnimations().orElse(AxolootlModelSettings.EMPTY_ENTITY_ANIMATIONS);
    }

    @Override
    public void setCustomAnimations(T entity, int instanceId, AnimationEvent animationEvent) {
        super.setCustomAnimations(entity, instanceId, animationEvent);
        if(AxolootlModelSettings.EMPTY_ENTITY_ANIMATIONS.equals(getAnimationResource(entity))) {
    ...
    protected void setupInitialAnimationValues(T entity, float netHeadYaw, float headPitch) {
        ...
        if (map.isEmpty()) {
            setRotations(body, headPitch * ((float)Math.PI / 180F), netHeadYaw * ((float)Math.PI / 180F), 0.0F);
    ...
    protected void setupLayStillOnGroundAnimation(float ageInTicks, float netHeadYaw) {
        ...
        this.body.setRotationY(this.lerpTo(this.body.getRotationY(), netHeadYaw * ((float)Math.PI / 180F)));
    ...
    protected void setupGroundCrawlingAnimation(float ageInTicks, float netHeadYaw) {
        ...
        this.lerpPart(this.leftFrontLeg, 1.0995574F, ((float)Math.PI / 2F) - scaledCosAgeInTicks, 0.0F);
        this.lerpPart(this.rightHindLeg, this.leftHindLeg.getRotationX(), -1.0F - f2, 0.0F);
        this.lerpPart(this.rightFrontLeg, this.leftFrontLeg.getRotationX(), (-(float)Math.PI / 2F) - scaledCosAgeInTicks, 0.0F);
        this.body.setRotationX(this.lerpTo(0.2F, this.body.getRotationX(), 0.0F));
        this.body.setRotationY(this.lerpTo(this.body.getRotationY(), netHeadYaw * ((float)Math.PI / 180F)));
        this.body.setRotationZ(this.lerpTo(this.body.getRotationZ(), 0.0F));
    }
    ...
    protected void setupWaterHoveringAnimation(float ageInTicks) {
        ...
        this.lerpPart(this.leftFrontLeg, ((float)Math.PI / 4F) - cosAgeInTicks * 0.2F, 2.042035F, 0.0F);
        this.applyMirrorLegRotations();
    ...
    protected void setupSwimmingAnimation(float ageInTicks, float headPitch) {
        ...
        this.body.setRotationX(this.lerpTo(0.1F, this.body.getRotationX(), headPitch * ((float)Math.PI / 180F) + scaledSinAgeInTicks));
        ...
        this.lerpPart(this.leftHindLeg, 1.8849558F, -0.4F * sinAgeInTicks, ((float)Math.PI / 2F));
        this.lerpPart(this.leftFrontLeg, 1.8849558F, -0.2F * coseAgeInTicks - 0.1F, ((float)Math.PI / 2F));
        this.applyMirrorLegRotations();
        this.head.setRotationY(this.lerpTo(this.head.getRotationY(), 0.0F));
        this.head.setRotationZ(this.lerpTo(this.head.getRotationZ(), 0.0F));
    }
